        ...
        return this.each(function () {
            ...
            this.createHtml = function () {
                ...
                if (para.dragDrop) {
                    ...
                    html += '					<div class="upload_btn" onclick="doload(parseInt(Math.random() * 6 + 1));">开始上传</div>';
                    html += "				</div>";
                    html += "			</div>";
                ...
                $(self).html(html).css({"width": para.width, "height": para.height});
                this.addEvent()
            };
            ...
            this.funDisposePreviewHtml = function (file, e) {
                ...
                var newStr = file.name.split("").reverse().join("");
                var type = newStr.split(".")[0].split("").reverse().join("");
                var fileImgSrc = "../../../static/zyupload/images/fileType/";
                if (type == "rar") {
