(function (u) {
    u.cjTextFx = function (L) {
        ...
        u.cjTextFx.animate = function (s, r) {
            ...
            function ta() {
                -1 < a ? (h && 0 === a && b[a].data({callback: m, isOut: !0}), b[a].animate({
                    left: f[a] + n,
                    opacity: 0
            ...
            function ua() {
                a < q ? (h && a === l && b[a].data({callback: m, isOut: !0}), b[a].animate({
                    left: f[a] - n,
                    opacity: 0
                }, e, d, g), a++) : clearInterval(c)
            }
            ...
            function Ba() {
                h && 0 === a && b[a].data({callback: m, isOut: !0});
                -1 < a ? (b[a].animate({left: f[a] + n, top: j, opacity: 0}, e, d, g), a--) : clearInterval(c)
            }

            function Ca() {
                h && a === l && b[a].data({callback: m, isOut: !0});
                a < q ? (b[a].animate({left: f[a] + n, top: j, opacity: 0}, e, d, g), a++) : clearInterval(c)
            }
            ...
            function Ha() {
                -1 < a ? (h && 0 === a && b[a].data({callback: m, isOut: !0}), 0 === a % 2 ? b[a].animate({
                    top: j,
                    opacity: 0
                }, e, d, g) : b[a].animate({top: -j, opacity: 0}, e, d, g), a--) : clearInterval(c)
            }

            function Ia() {
                a < q ? (h && a === l && b[a].data({callback: m, isOut: !0}), 0 === a % 2 ? b[a].animate({
                    top: j,
                    opacity: 0
                }, e, d, g) : b[a].animate({top: -j, opacity: 0}, e, d, g), a++) : clearInterval(c)
            }
            ...
            function Ja() {
                -1 < a ? (h && 0 === a && b[a].data({
                    ...
                    top: j,
                    opacity: 0
                }, e, d, g) : b[a].animate({left: f[a] + n, top: -j, opacity: 0}, e, d, g), a--) : clearInterval(c)
            }
            ...
            function S() {
                -1 < a ? (h && 0 === a && b[a].data({
                    callback: m,
                    isOut: !0
                }), b[a].animate({opacity: 0}, e, d, g), a--) : clearInterval(c)
            }
            ...
            function sa() {
                a < q ? (h && a === l && b[a].data("callback", m), E = b[a].height(), b[a].css({
                    ...
                    height: 0,
                    visibility: "visible"
                }).animate({height: E, opacity: 1}, e, d, g), a++) : clearInterval(c)
            }
            ...
            if (t.length && !(1 < t.length)) {
                ...
                t.css({color: p.color, height: t.height(), visibility: "visible", display: "block"});
                K = t.html();
                y = K.replace(/<\/?[^>]+>/igm, "");
                y = y.replace(/^\s+|\s+$/g, "");
                t.empty();
                ...
                D = Math.random();
                v[v.length] = {object: s, id: D, html: K, start: C, array: b, linkHandler: T, restore: p.restoreHTML};
                z = y = B = t = null
            }
        };
